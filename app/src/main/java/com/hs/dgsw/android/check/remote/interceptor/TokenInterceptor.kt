package com.hs.dgsw.android.check.remote.interceptor

import com.hs.dgsw.android.check.local.CheckInDataBase
import com.hs.dgsw.android.check.local.TokenDao
...
class TokenInterceptor: Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        runBlocking(Dispatchers.IO) {
            val dao = CheckInDataBase.getInstanceOrNull()?: throw RuntimeException()
